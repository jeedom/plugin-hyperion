...
sendVarToJS('eqType', 'hyperion2');
$eqLogics = eqLogic::byType('hyperion2');
?>
...
<div class="col-lg-10 col-md-9 col-sm-8 eqLogicThumbnailDisplay" style="border-left: solid 1px #EEE; padding-left: 25px;">
  ...
  <div class="cursor" id="bt_healthambilight" style="text-align: center; background-color : #ffffff; height : 120px;margin-bottom : 10px;padding : 5px;border-radius: 2px;width : 160px;margin-left : 10px;" >
...
</div><legend><i class="fa fa-lightbulb-o"></i>  {{Mes Ambilight}}
  </legend>
...
foreach ($eqLogics as $eqLogic) {
	...
	echo '<img src="plugins/hyperion2/doc/images/hyperion2_icon.png" height="105" width="95" />';
	echo "<br>";
...
?>
  ...
  <div class="form-group">
    ...
    <div class="col-sm-3">
      <input type="text" class="eqLogicAttr configuration form-control" data-l1key="configuration" data-l2key="port" placeholder="Port"/>
    </div>
  </div>
</fieldset>
</form>
...
<?php include_file('desktop', 'hyperion2', 'js', 'hyperion2');?>
